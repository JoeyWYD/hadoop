...
public class AverageWage {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //指定输入输出路径
        FileInputFormat.addInputPath(job, new Path("C:\\Users\\WS\\IdeaProjects\\Hadoop\\MapReduce\\src\\data\\input\\average_wage.txt"));
        FileOutputFormat.setOutputPath(job, new Path("C:\\Users\\WS\\IdeaProjects\\Hadoop\\MapReduce\\src\\data\\output\\AverageWage"));
        //指定map类
